...
class CityGuideAdapter: RecyclerView.Adapter<CityGuideAdapter.TypeDocumentGuideViewHolder>() {

    var listData: List<DataResponse>? = null
    var clickListener: OnClickListenerCustom<DataResponse>? = null

    fun setDataStorage(listData: List<DataResponse>?){
