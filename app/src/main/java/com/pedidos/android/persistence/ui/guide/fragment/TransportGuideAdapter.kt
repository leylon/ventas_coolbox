...
class TransportGuideAdapter: RecyclerView.Adapter<TransportGuideAdapter.TypeDocumentGuideViewHolder>() {

    var listStorage: List<DocumentTransportGuideResponse>? = null
    var clickListener: OnClickListenerCustom<DocumentTransportGuideResponse>? = null

    fun setDataStorage(listStorage: List<DocumentTransportGuideResponse>?){
    ...
    fun setOnItemClickListener(clickListener: OnClickListenerCustom<DocumentTransportGuideResponse>){
