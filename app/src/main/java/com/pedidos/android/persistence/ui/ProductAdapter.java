...
import com.pedidos.android.persistence.databinding.ProductItemBinding;
        ...
        if (mProductList == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return mProductList.get(oldItemPosition).getCodigoVenta() ==
                            productList.get(newItemPosition).getCodigoVenta();
                }
                ...
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    ...
                    return newProduct.getCodigoVenta() == oldProduct.getCodigoVenta()
                            && Objects.equals(newProduct.getDescripcion(), oldProduct.getDescripcion())
                            && Objects.equals(newProduct.getCodigo(), oldProduct.getCodigo())
                            && newProduct.getPrecio() == oldProduct.getPrecio();
                }
            });
            mProductList = productList;
