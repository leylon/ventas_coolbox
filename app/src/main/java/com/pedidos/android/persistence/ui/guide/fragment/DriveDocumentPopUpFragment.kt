...
class DriveDocumentPopUpFragment : DialogFragment, OnClickListenerCustom<DocumentIdResponse>  {

    var etwSearchDialog: EditText? = null
    var rvwDataSearch: RecyclerView? = null
    var driveGuideAdapter: DriveDocGuideAdapter? = null
    ...
    override fun onCreateView(
        ...
        driveGuideAdapter = DriveDocGuideAdapter()
        driveGuideAdapter?.setDataStorage(listAuxGuide)
        rvwDataSearch?.adapter = driveGuideAdapter
        driveGuideAdapter?.setOnItemClickListener(this@DriveDocumentPopUpFragment)
        ...
        etwSearchDialog?.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                rvwDataSearch?.layoutManager = linearLayoutManager
                driveGuideAdapter = DriveDocGuideAdapter()
                driveGuideAdapter?.setDataStorage(datafilte)
                rvwDataSearch?.adapter = driveGuideAdapter
                driveGuideAdapter?.setOnItemClickListener(this@DriveDocumentPopUpFragment)
            }
    ...
    override fun onClickDataListener(objectData: DocumentIdResponse) {
        val activity = activity as newDialoglistenerDriveGuide
    ...
    interface newDialoglistenerDriveGuide {
